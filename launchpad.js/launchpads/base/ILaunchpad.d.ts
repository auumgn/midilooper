 ...
 * struct.
 */
export declare type ButtonIn = number | [number, number] | Button;
/**
 ...
 */
export declare type PaletteColor = number;
export declare function isButton(x: ButtonIn): x is Button;
...
export declare type Style = {
    ...
    readonly style: 'flash';
    readonly color: number;
    readonly colorB?: number;
} | {
    readonly style: 'pulse';
    readonly color: number;
} | {
    readonly style: 'rgb';
