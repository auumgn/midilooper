...
import { BaseLaunchpad, groupByStyle, isRgbColor, validatePaletteColor, validateRgbColor } from '../base/BaseLaunchpad.js';
...
export class LaunchpadMK2 extends BaseLaunchpad {
    ...
    constructor(options) {
        var _a;
        super(options);
        this.openMidiDevice((_a = this.options.deviceName) !== null && _a !== void 0 ? _a : LaunchpadMK2.DEFAULT_DEVICE_NAME);
...
LaunchpadMK2.DEFAULT_DEVICE_NAME = /^Launchpad MK2/;
function scaleRgbMk2(color) {
    return validateRgbColor(color).map(v => Math.round(v * 63));
}
